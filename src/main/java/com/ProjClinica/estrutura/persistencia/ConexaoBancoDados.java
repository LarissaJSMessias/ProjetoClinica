package com.ProjClinica.estrutura.persistencia;
...
public class ConexaoBancoDados {
	...
	private EntityManagerFactory getCriarFabricaConexao() {
		...
		properties.put("hibernate.connection.url", "jdbc:mysql://127.0.0.1:3306/ProjClinica?createDatabaseIfNotExist=true&useSSL=false");
		...
		// properties.put("hibernate.connection.password", "root");
		 ...
		 properties.put("hibernate.default_schema", "ProjClinica");
