...
public abstract class GenericDao<T, ID extends Serializable> {
	...
	public List<T> findAll(Class<T> classe){
		...
		Query query = this.getEntityManager().createQuery("SELECT o FROM "+classe.getSimpleName()+" o"); // o select que se transforma no select nativo do banco de dados
		
		lista = query.getResultList();// processa todos os registro/ retorna o conteudo da tabela
